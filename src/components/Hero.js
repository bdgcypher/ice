...
export default function Hero() {
    return (
        <div className="relative flex flex-col-reverse h-screen py-16 lg:pt-0 lg:flex-col lg:pb-0">
            ...
            <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
                ...
                <div className="flex items-center">
                    ...
                    href="/"
                    aria-label=""
                    className="inline-flex items-center font-semibold text-gray-800 mx-1 transition-colors duration-200 hover:text-blue-400"
                    >
                    Learn more
                    </a>
                </div>
